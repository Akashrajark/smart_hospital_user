...
import 'package:smart_hospital/sections/appoinment/appointments_detials_screen.dart';
              ...
              children: [
                ...
                if (state is AppointmentsLoadingState && !_isLoadingMore)
                  ...
                  ListView.separated(
                    ...
                    shrinkWrap: true,
                    itemBuilder: (context, index) => CustomAppointmentCard(
                          ...
                          Navigator.push(
                              ...
                              MaterialPageRoute(
                                  builder: (context) => AppointmentsDetailsScreen(
                                        itemDetails: appointments[index],
                                      )));
                        }),
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ClipRRect(
                  borderRadius: BorderRadius.circular(8.0),
                  child: Image.network(appointmentDetails?['doctor']?['image_url'],
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        formatValue(appointmentDetails?['doctor']?['full_name']),
                        style: Theme.of(context).textTheme.titleLarge?.copyWith(
                              color: Theme.of(context).colorScheme.tertiary,
                              fontWeight: FontWeight.w700,
                            ),
                      ...
                      Text(
                        formatValue(appointmentDetails?['doctor']?['specialization']),
